...
- [FSII Codex 分发 API 订阅与配置指南](#fsii-codex-分发-api-订阅与配置指南)
  - [目录](#目录)
  - [1. 从网站获取 API](#1-从网站获取-api)
    - [1.1 登录网站](#11-登录网站)
    - [1.2 创建 API 密钥](#12-创建-api-密钥)
  - [2. 将 API 订阅导入 Codex](#2-将-api-订阅导入-codex)
    - [2.1 选择 Codex 类型并导入](#21-选择-codex-类型并导入)
    - [2.2 配置字段说明](#22-配置字段说明)
    - [2.3 重启 Codex](#23-重启-codex)
  - [3. 验证配置](#3-验证配置)
  - [4. 常见问题](#4-常见问题)
    - [4.1 提示未找到 API Key](#41-提示未找到-api-key)
    - [4.2 出现 `401` 或 `403`](#42-出现-401-或-403)
    - [4.3 出现 `404` 或模型不存在](#43-出现-404-或模型不存在)
    - [4.4 出现 `429`](#44-出现-429)
    - [4.5 Codex 可以启动，但请求一直失败](#45-codex-可以启动但请求一直失败)
  - [5. 其他提醒](#5-其他提醒)
    - [5.1 API 与账号安全](#51-api-与账号安全)
    - [5.2 费用与额度](#52-费用与额度)
    - [5.3 数据与科研合规](#53-数据与科研合规)
    - [5.4 配置与更新](#54-配置与更新)
  - [6. 参考资料](#6-参考资料)
  - [维护与反馈](#维护与反馈)
